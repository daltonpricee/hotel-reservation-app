...
/**
*Standard room reservation and info.
*/
public class StandardRoom {
   ...
   */
   ...
   /**
   *Add reservation for standard room.
   ...
   */ 
   ...
   /**
   *Cancel reservation for standard room.
   ...
   */
   ...
   /**
   *Loop through reservations and print info of all. 
   */ 
   public void showSR() {
